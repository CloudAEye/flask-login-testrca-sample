...
from src.flask_login import AnonymousUserMixin
from src.flask_login import confirm_login
from src.flask_login import current_user
from src.flask_login import decode_cookie
from src.flask_login import encode_cookie
from src.flask_login import FlaskLoginClient
from src.flask_login import fresh_login_required
from src.flask_login import login_fresh
from src.flask_login import login_remembered
from src.flask_login import login_required
from src.flask_login import login_url
from src.flask_login import login_user
from src.flask_login import LoginManager
from src.flask_login import logout_user
from src.flask_login import make_next_param
from src.flask_login import session_protected
from src.flask_login import set_login_view
from src.flask_login import user_accessed
from src.flask_login import user_loaded_from_cookie
from src.flask_login import user_loaded_from_request
from src.flask_login import user_logged_in
from src.flask_login import user_logged_out
from src.flask_login import user_login_confirmed
from src.flask_login import user_needs_refresh
from src.flask_login import user_unauthorized
from src.flask_login import UserMixin
from src.flask_login.utils import _secret_key
from src.flask_login.utils import _user_context_processor
...
class LoginTestCase(unittest.TestCase):
    ...
    def test_remember_me_uses_custom_cookie_parameters(self):
        ...
        duration = self.app.config["REMEMBER_COOKIE_DURATION"] = 10
        ...
        expected_date = datetime.now(timezone.utc) + timedelta(seconds=duration)
    ...
    def test_remember_me_with_invalid_duration_returns_500_response(self):
        self.app.config["REMEMBER_COOKIE_DURATION"] = timedelta(seconds=123)
    ...
    def test_set_cookie_with_invalid_duration_raises_exception(self):
        ...
        # self.assertFalse(cm.exception, expected_exception_message)
    ...
    def test_remember_me_refresh_each_request(self):
        with patch("src.flask_login.login_manager.datetime") as mock_dt:
